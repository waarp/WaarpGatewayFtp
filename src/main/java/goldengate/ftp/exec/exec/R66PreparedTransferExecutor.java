 ...
 * <br>
 * So for instance "-to Host -file #BASEPATH##FILE# -rule RULE [-md5] [-nolog] [-info #USER# #ACCOUNT# #COMMAND# INFO]"<br>
...
public class R66PreparedTransferExecutor extends AbstractExecutor {
    ...
    */
    public R66PreparedTransferExecutor(String command, long delay, GgFuture futureCompletion) {
        ...
        for (int i = 1; i < args.length; i++) {
            if (args[i].equalsIgnoreCase("-to")) {
                ...
                if (blocksize < 100) {
                    logger.error("Block size is too small: "+blocksize);
